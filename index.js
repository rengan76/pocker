...
function main() {
	...
	var shuffle = api('https://deckofcardsapi.com/api/deck/new/shuffle/?deck_count=1');
    shuffle.then(function(result) {
        deckDetails = result;
         console.log('https://deckofcardsapi.com/api/deck/'+deckDetails.deck_id+'/draw/?count=5');
		 var cards = api('https://deckofcardsapi.com/api/deck/'+deckDetails.deck_id+'/draw/?count=5');
		   cards.then(function(result) {
			   console.log(result.cards);
			   
			   var array = result.cards;
			   var arrayCards = [];
			   
			   array.forEach(function(element) {
				  
				  if (element.value == 'JACK') element.value = 'J';
				  if (element.value == 'QUEEN') element.value = 'Q';
				  if (element.value == 'KING') element.value = 'K';
				  if (element.value == 'ACE') element.value = 'A';
				  
				   var a = element.value + suitMap[element.suit];
				       arrayCards.push(a);
